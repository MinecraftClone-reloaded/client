...
function enable() {
    ...
    event.registerEvent("touchDown", function(data) {
        if(enabled) {
            if(data[3] == 0) {
                main.game.world.editBoxByRayCast(main.game.camera, main.game.camera.position, main.game.camera.direction, api.newModBlock("texture/Redstone.PNG"), false, null);
            } else if(data[3] == 1) {
